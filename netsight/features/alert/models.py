...
from netsight.core.database.mixins import AuditTimeMixin, AuditUserMixin
from netsight.core.database.types import DateTimeTZ, bool_false, bool_true, i18n_name, int_pk
from netsight.core.utils.processors import format_duration
from netsight.features.alert.consts import (
    AlertSeverityType,
    AlertStatusType,
    EventOperationType,
