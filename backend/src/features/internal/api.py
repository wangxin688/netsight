...
async def get_permissions(session: SqlaSession, user: AuthUser) -> list[schemas.Permission]:
...
async def sync_db_permission(session: SqlaSession, user: AuthUser, request: Request) -> dict:
