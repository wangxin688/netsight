...
from app.consts import IPAddressStatus, IPRangeStatus, PrefixStatus, VLANStatus
from app.db.database import Base
from app.db.db_types import IPvAnyInterface, IPvAnyNetwork, PgCIDR, PgIpInterface, bool_false, bool_true, int_pk
from app.db.mixins import AuditLogMixin

if TYPE_CHECKING:
    from app.db import ISP, Interface, IPRole, Site, User
