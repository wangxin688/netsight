...
class RackRole(Base, AuditTimeMixin, AuditUserMixin):
...
class DeviceRole(Base, AuditTimeMixin, AuditUserMixin):
...
class CircuitType(Base, AuditTimeMixin, AuditUserMixin):
